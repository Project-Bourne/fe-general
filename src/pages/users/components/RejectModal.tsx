...
function RejectModal({cancelblock, handleReject, user}) {
  return (
    <>
    <h1 className="font-semibold text-[24px] px-2 mb-3"> Reject user </h1>
