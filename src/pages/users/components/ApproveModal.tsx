...
function ApproveModal({cancelblock, handleApprove, user}) {
  return (
    <>
    <h1 className="font-semibold text-[24px] px-2 mb-3"> Approve user </h1>
